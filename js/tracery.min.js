  ...
  (function (r) {
    ...
    function g(e, t) {
      return function () {
        ...
        return (
          typeof n[0] != "string" && n.length === 1 && n.push(null),
      ...
      function n(n) {
        function l(e) {
          if (o !== e) {
            ...
            if (!u)
              tracery.addError(
                "multiple possible expansion symbols in tag!" + n
              );
            else {
              u = !1;
              var r = t.split(".");
        ...
        return { preActions: r, postActions: i, symbol: a, mods: f, raw: n };
      }
      function r(t) {
        function u(e) {
    ...
    n("action", [], function () {
      var e = function (e, t) {
        (this.node = e), (this.grammar = e.grammar), (this.raw = t);
      };
      return (
    ...
    n("inheritance", function () {}),
    n("node", ["./action", "./inheritance"], function (e, t) {
      var n = 0,
        i = Class.extend({
          init: function () {
            (this.depth = 0),
          ...
          expandChildren: function () {
            if (this.children) {
              ...
              for (var e = 0; e < this.children.length; e++)
                this.children[e].expand(),
                  (this.childText += this.children[e].finalText);
              this.finalText = this.childText;
            }
          },
          createChildrenFromSections: function (e) {
            var t = this;
        ...
        s = i.extend({
          init: function (e, t) {
            this._super(),
              (this.grammar = e),
              (this.parsedRule = tracery.parseRule(t));
          },
          expand: function () {
            var e = this;
        ...
        o = i.extend({
          ...
          expand: function () {
            tracery.outputExpansionTrace && console.log(r.sections),
              ...
              this.rule.error &&
                ((this.error = this.rule.error), tracery.addError(this.error)),
              (this.actions = []),
            ...
            for (var t = 0; t < this.mods.length; t++)
              this.finalText = this.grammar.applyMod(
                this.mods[t],
                this.finalText
              );
          },
    ...
    n("rule/rule", [], function () {
      var e = function (e) {
        (this.raw = e), (this.sections = tracery.parseRule(e));
      };
      return (
        (e.prototype.getParsed = function () {
          return (
            this.sections || (this.sections = tracery.parseRule(raw)),
            this.sections
          );
        }),
    ...
    n("rule/ruleset", ["./rule"], function (e) {
      var t = Object.freeze({ RED: 0, GREEN: 1, BLUE: 2 }),
        n = function (e) {
          if (e.constructor === Array) e = e.slice(0, e.length);
          else if (e.prototype !== n) {
            if (!(typeof e == "string" || e instanceof String))
              throw (
                (console.log(e), "creating ruleset with unknown object type!")
              );
          ...
          for (var r = 0; r < this.rules.length; r++)
            (this.uses[r] = 0),
              (this.startUses[r] = this.uses[r]),
              (this.totalUses += this.uses[r]);
        };
      return (
        (n.prototype.parseAll = function (t) {
          for (var n = 0; n < this.rules.length; n++)
            this.rules[n].prototype !== e &&
              (this.rules[n] = new e(this.rules[n]));
        }),
        ...
        (n.prototype.applyToRules = function (e) {
          for (var t = 0; t < this.rules.length; t++) e(this.rules[t], t);
        }),
        ...
        (n.prototype.getIndex = function () {
          var e = this.getRandomIndex(),
            ...
            n = 0;
          while (this.uses[e] > t && n < 20) (e = this.getRandomIndex()), n++;
          return e;
        }),
        ...
        (n.prototype.testRandom = function () {
          ...
          var e = [];
          for (var t = 0; t < this.uses.length; t++) e[t] = 0;
          var n = 10 * this.uses.length;
          for (var t = 0; t < n; t++) {
            var r = this.getIndex();
            (this.uses[r] += 1), e[r]++, this.decayUses(0.1);
          }
    ...
    n("symbol", ["./rule/ruleset"], function (e) {
      ...
      return (
        (t.prototype.loadFrom = function (e) {
          (e = this.wrapRules(e)),
            (this.baseRules = e),
            this.ruleSets.push(e),
    ...
    n(
      "grammar",
      ["./modifiers", "./node", "./symbol", "./rule/rule"],
      function (e, t, n, r) {
        function i() {
          this.clear();
        }
        return (
          (i.prototype.clear = function () {
            ...
            for (var t in e) e.hasOwnProperty(t) && (this.modifiers[t] = e[t]);
          }),
          (i.prototype.loadFrom = function (e) {
            ...
            for (var i = 0; i < r.length; i++) {
              var s = r[i];
              this.symbolNames.push(s),
                (this.symbols[s] = new n(this, s)),
                this.symbols[s].loadFrom(t[s]);
            }
          }),
          ...
          (i.prototype.addOrGetSymbol = function (e) {
            return (
              this.symbols[e] === undefined && (this.symbols[e] = new n(e)),
              this.symbols[e]
            );
          }),
          ...
          (i.prototype.applyMod = function (e, t) {
            if (!this.modifiers[e])
              throw (console.log(this.modifiers), "Unknown mod: " + e);
    ...
    n(
      "traceryCore",
      ["./utilities", "./grammar", "./node"],
      function (e, t, n) {
        var r = {};
        return (
          $.extend(r, e),
          (r.createGrammar = function (e) {
            var n = new t();
